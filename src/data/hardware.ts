 ...
 *
 * `photo`  — true when public/images/hardware/<slug>.webp exists.
 *            Generated by scripts/fetch-hardware-images.mjs.
...
export const IMAGE_CREDITS = credits as Record<string, ImageCredit>;
